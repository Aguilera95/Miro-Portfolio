    ...
    <div className="Container" id="footerContainer">
      ...
      >
        <ReactBootstrap.Nav className="mr-auto" id="mr-autoId">
          ...
          <ReactBootstrap.Nav.Link href="tel:214-636-7724" id="FootLink">
            214-636-7724
          </ReactBootstrap.Nav.Link>
          <ReactBootstrap.Nav.Link href="tel:2146367724" id="footerIconLink">
            <img
          ...
          <ReactBootstrap.Nav.Link href="mailto: aguilera8756@gmail.com" id="FootLink">
            aguilera8756@gmail.com
          </ReactBootstrap.Nav.Link>
          <ReactBootstrap.Nav.Link
            href="mailto:aguilera8756@gmail.com"
            id="footerIconLink"
          >
            <img
          ...
          <ReactBootstrap.Nav.Link href="https://github.com/Aguilera95" id="FootLink">
            GitHub
          </ReactBootstrap.Nav.Link>
          <ReactBootstrap.Nav.Link href="https://github.com/Aguilera95" id="footerIconLink">
            <img
          ...
          <ReactBootstrap.Nav.Link href="https://www.linkedin.com/in/miroslava-aguilera-6077a9172/" id="FootLink">
            LinkedIn
          </ReactBootstrap.Nav.Link>
          <ReactBootstrap.Nav.Link href="https://www.linkedin.com/in/miroslava-aguilera-6077a9172/" id="footerIconLink">
            <img
